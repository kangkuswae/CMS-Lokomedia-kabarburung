...
switch(isset($_GET['act']) ?$_GET['act']:''){
  ...
  case "tambahberita":
    ...
    echo "</select></td></tr>
          <tr><td>Isi Berita</td>  <td> : <textarea name='isi_berita' cols=80 rows=16></textarea></td></tr>
  ...
  case "editberita":
    ...
    echo "</select></td></tr>
          <tr><td>Isi Berita</td>   <td> : <textarea name='isi_berita' cols=80 rows=16>$r[isi_berita]</textarea></td></tr>
          <tr><td>Gambar</td>       <td> : <img src='../foto_berita/small_$r[gambar]'></td></tr>
