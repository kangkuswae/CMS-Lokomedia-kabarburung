...
switch(isset($_GET['act']) ?$_GET['act']:''){
  ...
  case "tambahagenda":
    ...
    echo "</td></tr>
          ...
          <tr><td>Pengirim (Contact Person)</td>    <td> : <input type=text name='pengirim' size=40></td></tr>
  ...
  case "editagenda":
    ...
    echo "</td></tr>
          ...
          <tr><td>Contact Person</td>    <td> : <input type=text name='pengirim' size=40 value='$r[pengirim]'></td></tr>
